...
public class KeyboardInput implements KeyListener{
	...
	@Override 
	public void keyPressed(KeyEvent e) { //setta tecla como pressionada ao pressiona-lá
	...
	public void keyReleased(KeyEvent e) { //setta tecla como não pressionada ao soltá-la
		int code = e.getKeyCode();
		if (code == KeyEvent.VK_UP) {
			upPressed = false;
		}
